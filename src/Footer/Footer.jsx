    ...
    <div className="footer-wrapper">
      <div className="footer container py-3">
        ...
        <div className="info-rows">
          ...
          <div className="links">
            <div className="title">{formatMessage(messages.Links)}</div>
            <div><a href="https://lms.hutech.edu.vn">{formatMessage(messages.LMS)}</a></div>
            <div><a href="https://dlc.hutech.edu.vn/hutech-x-doc">{formatMessage(messages.Guide)}</a></div>
            <div><a href="https://apps.apple.com/us/app/hutech-elearning/id1632853626">{formatMessage(messages.DownloadAndroid)}</a></div>
            <div><a href="https://play.google.com/store/apps/details?id=vn.edu.hutech.lms">{formatMessage(messages.DownloadIOS)}</a></div>
          </div>
        </div>
